...
public class HBaseUtils {
    ...
    static{
        ...
        conf.set("hbase.rootdir","hdfs://10-255-0-242:9000/hbase");
        //使用eclipse时必须添加这个，否则无法定位
        conf.set("hbase.zookeeper.quorum","10-255-0-197:2181,10-255-0-192:2181,10-255-0-253:2181");
